#!/usr/bin/env bash
# ZapClaw mTLS Certificate Generator
...
KEY_SIZE=4096
CN_CA="ZapClaw CA"
CN_SERVER="zapclaw-server"
CN_CLIENT="zapclaw-client"

echo "🔐 ZapClaw Certificate Generator"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
openssl req -new -x509 \
    ...
    -days "$DAYS" \
    -subj "/CN=$CN_CA/O=ZapClaw/OU=Security" \
    2>/dev/null
...
openssl req -new \
    ...
    -subj "/CN=$CN_SERVER/O=ZapClaw/OU=Server" \
    2>/dev/null
...
openssl req -new \
    ...
    -subj "/CN=$CN_CLIENT/O=ZapClaw/OU=Client" \
    2>/dev/null
...
echo ""
echo "  Usage:"
echo "    zapclaw --client-cert $OUTPUT_DIR/client-cert.pem \\"
