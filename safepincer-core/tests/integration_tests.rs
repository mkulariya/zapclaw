//! Integration tests for the SafePincer core agent.
//!
...
use safepincer_core::agent::{Agent, Tool, ToolRegistry};
use safepincer_core::config::Config;
use safepincer_core::confiner::Confiner;
use safepincer_core::llm::{ChatMessage, LlmClient, LlmResponse, ToolCall, ToolDefinition, TokenUsage};
    ...
    fn tool_call_response(name: &str, args: &str) -> LlmResponse {
        LlmResponse {
            ...
            tool_calls: vec![ToolCall {
                ...
                function: safepincer_core::llm::FunctionCall {
                    name: name.to_string(),
