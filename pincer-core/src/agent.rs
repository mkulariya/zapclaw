...
/// The Pincer Agent — core observe-plan-act-reflect loop.
///
/// This is the heart of Pincer. It processes tasks by:
...
impl Agent {
    ...
    fn build_system_prompt(&self) -> String {
        ...
        // Identity
        sections.push("You are Pincer 🦞, a secure and efficient personal AI assistant.".to_string());
